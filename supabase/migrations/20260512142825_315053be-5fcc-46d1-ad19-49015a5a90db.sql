CREATE OR REPLACE FUNCTION public.create_conference_order(p_room_id uuid, p_service_date date, p_guest_name text, p_company text, p_email text, p_meal_type text, p_participants integer, p_notes text, p_items jsonb DEFAULT '[]'::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
