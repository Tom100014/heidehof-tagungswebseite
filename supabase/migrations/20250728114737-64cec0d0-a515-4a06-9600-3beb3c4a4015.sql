-- Migration: Tagungsgast-Bestellungen in conference_orders Tabelle übertragen
...
SELECT 
  ...
  CASE 
    ...
    ELSE NULL
  END as dinner_menu,
  -- order_date aus menuDate extrahieren und in YYYY-MM-DD Format konvertieren
  CASE 
    WHEN metadata->>'menuDate' LIKE '%28. July 2025%' THEN '2025-07-28'
    WHEN metadata->>'menuDate' LIKE '%29. July 2025%' THEN '2025-07-29'
    WHEN metadata->>'menuDate' LIKE '%30. July 2025%' THEN '2025-07-30'
    ELSE DATE(created_at)::text
  END as order_date,
  created_at,
  status,
