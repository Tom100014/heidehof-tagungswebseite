-- Keep the stored Cartesia telephone-agent prompt fresh whenever hotel offer
-- data changes. The Edge Function stores the generated prompt in
-- app_settings.cartesia_system_prompt for manual copy/paste into Cartesia.
